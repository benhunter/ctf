...
/*    */     try {
/* 47 */       return this.type.cast(this.newInstanceMethod.invoke(null, new Object[] { this.type, this.objectConstructorId }));
/*    */     }
...
/*    */       
/* 72 */       return (Long)newInstanceMethod.invoke(null, new Object[] { Object.class });
/*    */     }
...
/* Location:              /home/kali/ctf/htb/fatty-10.10.10.174/ftp/fatty-client.jar!/org/springframework/objenesis/instantiator/android/Android18Instantiator.class

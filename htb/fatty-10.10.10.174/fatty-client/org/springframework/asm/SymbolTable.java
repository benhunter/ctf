...
/*      */ 
/*      */     
/*  142 */     byte[] inputBytes = classReader.b;
...
/*      */       } 
/*  225 */       itemIndex += (itemTag == 5 || itemTag == 6) ? 2 : 1;
/*      */     } 
/*      */ 
/*      */ 
/*      */     
...
/*  245 */     byte[] inputBytes = classReader.b;
...
/*      */ 
/*      */     
/* 1049 */     for (Object bootstrapMethodArgument : bootstrapMethodArguments) {
/* 1050 */       addConstant(bootstrapMethodArgument);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
/*      */     
/* 1056 */     int bootstrapMethodOffset = bootstrapMethodsAttribute.length;
/* 1057 */     bootstrapMethodsAttribute.putShort(
/* 1058 */         (addConstantMethodHandle(bootstrapMethodHandle
/* 1059 */           .getTag(), bootstrapMethodHandle
/* 1060 */           .getOwner(), bootstrapMethodHandle
/* 1061 */           .getName(), bootstrapMethodHandle
/* 1062 */           .getDesc(), bootstrapMethodHandle
/* 1063 */           .isInterface())).index);
/*      */     
/* 1065 */     int numBootstrapArguments = bootstrapMethodArguments.length;
/* 1066 */     bootstrapMethodsAttribute.putShort(numBootstrapArguments);
/* 1067 */     for (Object bootstrapMethodArgument : bootstrapMethodArguments) {
/* 1068 */       bootstrapMethodsAttribute.putShort((addConstant(bootstrapMethodArgument)).index);
/*      */     }
/*      */ 
/*      */     
/* 1072 */     int bootstrapMethodlength = bootstrapMethodsAttribute.length - bootstrapMethodOffset;
/* 1073 */     int hashCode = bootstrapMethodHandle.hashCode();
/* 1074 */     for (Object bootstrapMethodArgument : bootstrapMethodArguments) {
/* 1075 */       hashCode ^= bootstrapMethodArgument.hashCode();
/*      */     }
/* 1077 */     hashCode &= Integer.MAX_VALUE;
/*      */ 
/*      */     
/* 1080 */     return addBootstrapMethod(bootstrapMethodOffset, bootstrapMethodlength, hashCode);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1094 */     byte[] bootstrapMethodsData = this.bootstrapMethods.data;
/* 1095 */     Entry entry = get(hashCode);
/* 1096 */     while (entry != null) {
/* 1097 */       if (entry.tag == 64 && entry.hashCode == hashCode) {
/* 1098 */         int otherOffset = (int)entry.data;
/* 1099 */         boolean isSameBootstrapMethod = true;
/* 1100 */         for (int i = 0; i < length; i++) {
/* 1101 */           if (bootstrapMethodsData[offset + i] != bootstrapMethodsData[otherOffset + i]) {
/* 1102 */             isSameBootstrapMethod = false;
/*      */             break;
/*      */           } 
/*      */         } 
/* 1106 */         if (isSameBootstrapMethod) {
/* 1107 */           this.bootstrapMethods.length = offset;
/* 1108 */           return entry;
/*      */         } 
/*      */       } 
/* 1111 */       entry = entry.next;
/*      */     } 
/* 1113 */     return put(new Entry(this.bootstrapMethodCount++, 64, offset, hashCode));
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1127 */     return this.typeTable[typeIndex];
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1138 */     int hashCode = hash(128, value);
/* 1139 */     Entry entry = get(hashCode);
/* 1140 */     while (entry != null) {
/* 1141 */       if (entry.tag == 128 && entry.hashCode == hashCode && entry.value.equals(value)) {
/* 1142 */         return entry.index;
/*      */       }
/* 1144 */       entry = entry.next;
/*      */     } 
/* 1146 */     return addTypeInternal(new Entry(this.typeCount, 128, value, hashCode));
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1159 */     int hashCode = hash(129, value, bytecodeOffset);
/* 1160 */     Entry entry = get(hashCode);
/* 1161 */     while (entry != null) {
/* 1162 */       if (entry.tag == 129 && entry.hashCode == hashCode && entry.data == bytecodeOffset && entry.value
/*      */ 
/*      */         
/* 1165 */         .equals(value)) {
...
/*      */     } 
/* 1170 */     return addTypeInternal(new Entry(this.typeCount, 129, value, bytecodeOffset, hashCode));
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1187 */     long data = typeTableIndex1 | typeTableIndex2 << 32L;
/* 1188 */     int hashCode = hash(130, typeTableIndex1 + typeTableIndex2);
/* 1189 */     Entry entry = get(hashCode);
/* 1190 */     while (entry != null) {
/* 1191 */       if (entry.tag == 130 && entry.hashCode == hashCode && entry.data == data) {
/* 1192 */         return entry.info;
/*      */       }
/* 1194 */       entry = entry.next;
/*      */     } 
/* 1196 */     String type1 = (this.typeTable[typeTableIndex1]).value;
/* 1197 */     String type2 = (this.typeTable[typeTableIndex2]).value;
/* 1198 */     int commonSuperTypeIndex = addType(this.classWriter.getCommonSuperClass(type1, type2));
/* 1199 */     (put(new Entry(this.typeCount, 130, data, hashCode))).info = commonSuperTypeIndex;
/* 1200 */     return commonSuperTypeIndex;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1212 */     if (this.typeTable == null) {
/* 1213 */       this.typeTable = new Entry[16];
/*      */     }
/* 1215 */     if (this.typeCount == this.typeTable.length) {
/* 1216 */       Entry[] newTypeTable = new Entry[2 * this.typeTable.length];
/* 1217 */       System.arraycopy(this.typeTable, 0, newTypeTable, 0, this.typeTable.length);
/* 1218 */       this.typeTable = newTypeTable;
/*      */     } 
/* 1220 */     this.typeTable[this.typeCount++] = entry;
/* 1221 */     return (put(entry)).index;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1229 */     return Integer.MAX_VALUE & tag + value;
/*      */   }
/*      */   
/*      */   private static int hash(int tag, long value) {
/* 1233 */     return Integer.MAX_VALUE & tag + (int)value + (int)(value >>> 32L);
/*      */   }
/*      */   
/*      */   private static int hash(int tag, String value) {
/* 1237 */     return Integer.MAX_VALUE & tag + value.hashCode();
/*      */   }
/*      */   
/*      */   private static int hash(int tag, String value1, int value2) {
/* 1241 */     return Integer.MAX_VALUE & tag + value1.hashCode() + value2;
/*      */   }
/*      */   
/*      */   private static int hash(int tag, String value1, String value2) {
/* 1245 */     return Integer.MAX_VALUE & tag + value1.hashCode() * value2.hashCode();
/*      */   }
/*      */ 
/*      */   
/*      */   private static int hash(int tag, String value1, String value2, int value3) {
/* 1250 */     return Integer.MAX_VALUE & tag + value1.hashCode() * value2.hashCode() * (value3 + 1);
/*      */   }
/*      */ 
/*      */   
/*      */   private static int hash(int tag, String value1, String value2, String value3) {
/* 1255 */     return Integer.MAX_VALUE & tag + value1.hashCode() * value2.hashCode() * value3.hashCode();
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1264 */     return Integer.MAX_VALUE & tag + value1.hashCode() * value2.hashCode() * value3.hashCode() * value4;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1293 */       super(index, tag, owner, name, value, data);
/* 1294 */       this.hashCode = hashCode;
/*      */     }
/*      */     
/*      */     Entry(int index, int tag, String value, int hashCode) {
/* 1298 */       super(index, tag, null, null, value, 0L);
/* 1299 */       this.hashCode = hashCode;
/*      */     }
/*      */     
/*      */     Entry(int index, int tag, String value, long data, int hashCode) {
/* 1303 */       super(index, tag, null, null, value, data);
/* 1304 */       this.hashCode = hashCode;
/*      */     }
/*      */ 
/*      */     
/*      */     Entry(int index, int tag, String name, String value, int hashCode) {
/* 1309 */       super(index, tag, null, name, value, 0L);
/* 1310 */       this.hashCode = hashCode;
/*      */     }
/*      */     
/*      */     Entry(int index, int tag, long data, int hashCode) {
/* 1314 */       super(index, tag, null, null, null, data);
/* 1315 */       this.hashCode = hashCode;
/*      */     }
/*      */   }
/*      */ }


/* Location:              /home/kali/ctf/htb/fatty-10.10.10.174/ftp/fatty-client.jar!/org/springframework/asm/SymbolTable.class
